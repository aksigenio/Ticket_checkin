...
export function customerTicketEmailHtml(opts: {
  ...
  const posterBlock = opts.hasPoster
    ? `<p style="margin:20px 0 0"><img src="cid:${opts.posterCid}" alt="Афиша «Мир Дверь Мяч»" width="560" style="max-width:100%;height:auto;border-radius:10px;display:block" /></p>`
    : "";
